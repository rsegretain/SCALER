...
utils.plot_cpu_per_replicas(global_result_folder_path, plots_folder_path, getServiceNameFromPodName, subtitle, CPU_LIMIT, caption=caption)

# CPU per service

utils.plot_cpu_per_service(global_result_folder_path, plots_folder_path, getServiceNameFromPodName, subtitle, CPU_LIMIT, caption=caption)
